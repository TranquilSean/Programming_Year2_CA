...
public class Player_Movements : MonoBehaviour
{
    ...
    {
        playerActionsAsset.Gameplay.Jump.started += DoJump;
        move = playerActionsAsset.Gameplay.Movement;
        playerActionsAsset.Gameplay.Enable();
    }

    private void OnDisable()
    {
        playerActionsAsset.Gameplay.Jump.started -= DoJump;
        playerActionsAsset.Gameplay.Disable();
    }
